...
async def killdabot(event):
    ...
    await event.edit("**Mematikan ALBERT-USERBOT....**")
...
async def killdabot(event):
    await event.edit("**Restarting ALBERT-USERBOT...**")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[🎭𝐀𝐋𝐁𝐄𝐑𝐓-𝐔𝐒𝐄𝐑𝐁𝐎𝐓🎭](https://github.com/Lordtrek/ALBERT-USERBOT/blob/ALBERT-USERBOT/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "**Usᴇʀʙᴏᴛ Tᴇʟᴇɢʀᴀᴍ**\n"
        "𝗥𝗲𝗽𝗼 🇮🇩\n"
        "╰⎆ [🎭𝐀𝐋𝐁𝐄𝐑𝐓-𝐔𝐒𝐄𝐑𝐁𝐎𝐓🎭​](https://github.com/Lordtrek/ALBERT-USERBOT)\n"
        "❏ **Oᴡɴᴇʀ​** ⎆ [ᴀʟʙᴇʀᴛ](t.me/AlbertEinsteinih)\n"
        "❏ **Sᴜᴘᴘᴏʀᴛ**​ ⎆ [sᴜᴘᴘᴏʀᴛ](t.me/suportalbert)\n"
    )
