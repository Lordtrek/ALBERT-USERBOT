...
@register(outgoing=True, pattern=r"^\.(ALBERTUBOT)\s?(.)?")
async def amireallyalive(alive):
    user = await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
        f"🎭 ALBERT-USERBOT 🎭丨ᐯ乇\n\n"
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n"
        f"[ɢʀᴏᴜᴘꜱ](https://t.me/suportalbert) | [ʙᴏᴛᴏꜰ](https://t.me/{user.username}) | [ɢɪᴛʜᴜʙ](https://github.com/Lordtrek/ALBERT-USERBOT)"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
@register(outgoing=True, pattern=r"^\.(?:ALBERT)\s?(.)?")
async def amireallyalive(alive):
    await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
...
async def redis(alive):
    ...
    output = (
        ...
        f"┃✧ **GitHub   :** [UserBot](https://github.com/Lordtrek/ALBERT-USERBOT) \n"
        f"┃✧ **Owner    :** [ALBERT](https://t.me/AlbertEinsteinih) \n"
        f"┃✧ **support  :** [groups](https://t.me/suportalbert) \n"
        f"╰✠╼━━━━━━━━━━━━━━━━✠╯"
    )
    if ALIVE_LOGO:
        try:
