...
ALIVE_LOGO = (os.environ.get("ALIVE_LOGO")
              or "https://telegra.ph/file/9f96929759e19c4d35f0e.jpg")
...
async def check_alive():
    await bot.send_message(
        BOTLOG_CHATID,
        "**𝐀𝐋𝐁𝐄𝐑𝐓-𝐔𝐒𝐄𝐑𝐁𝐎𝐓 Has Been Deployed**\n━━━━━━━━━━━━━━━\n❃ **Branch :** `🎭𝐀𝐋𝐁𝐄𝐑𝐓-𝐔𝐒𝐄𝐑𝐁𝐎𝐓🎭`\n❃ **BotVer :** `8.0.0`\n━━━━━━━━━━━━━━━\n❃ **Support :*@suportalbert* @\n━━━━━━━━━━━━━━━")
    return
...
with bot:
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    f"❁ __Saya Adalah Albert-Userbot Yang Digunakan Banyak User Telegram__.\n\n"
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                text = (
                    ...
                    f"× **Pembaruan Data Untuk 🎭𝐀𝐋𝐁𝐄𝐑𝐓-𝐔𝐒𝐄𝐑𝐁𝐎𝐓🎭​, Command Untuk Pembaruan**.\n"
                    f"⚒Pembaruan Data :\n"
                    f"`.update deploy`\n"
                    f"`update`\n\n"
                    f"© @suportalbert")
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    link_preview=True,
                    buttons=[
                        [Button.url("ᴄʜᴀɴɴᴇʟ", "t.me/albertsupotry")],
                    ],
                )
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(""):
                ...
                result = builder.article(
                    "Bantuan Dari **🎭𝐀𝐋𝐁𝐄𝐑𝐓-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​🎭**",
                    text="Daftar Plugins",
                    buttons=[],
                    link_preview=True,
                )
            else:
                result = builder.article(" **🎭𝐀𝐋𝐁𝐄𝐑𝐓-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​🎭**",
                                         text="""°🎭𝐀𝐋𝐁𝐄𝐑𝐓-𝐔𝐒𝐄𝐑𝐁𝐎𝐓🎭°""",
                                         buttons=[[custom.Button.url("ᴀʟʙᴇʀᴛ",
                                                                     "https://github.com/Lordtrek/ALBERT-USERBOT"),
                                                   custom.Button.url("ᴄʜᴀɴɴᴇʟ​",
                                                                     "t.me/albertsupotry"),
                                                   ],
                                                  [custom.Button.url("ʟɪᴄᴇɴsᴇ​",
                                                                     "https://github.com/Lordtrek/ALBERT-USERBOT/LICENSE",
                                                                     )],
                                                  ],
                                         link_preview=False,
                                         )
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # userbot
                ...
                await event.edit(
                    ...
                    buttons=[
                        [
                            Button.url("❈ꜱᴜᴘᴘᴏʀᴛ❈", "t.me/suportalbert"),
                            Button.url("❈ᴄʜᴀɴɴᴇʟ❈", "t.me/albertsupotry"),
                        ],
                        [custom.Button.inline(
